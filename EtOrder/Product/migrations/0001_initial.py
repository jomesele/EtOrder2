    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='media/Company-logo/')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('company', models.ForeignKey(default=False, on_delete=django.db.models.deletion.CASCADE, to='Product.Company')),
            ],
            options={
